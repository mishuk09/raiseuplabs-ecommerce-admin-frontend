...
const CatUpdatePost = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const response = await axios.get(`https://riseuplabs-ecommerce-backend.onrender.com/cate/${id}`, {
                    headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(`https://riseuplabs-ecommerce-backend.onrender.com/cate/cateupdate/${id}`, formData, {
                headers: {
                    'Authorization': `Bearer ${token}`,
